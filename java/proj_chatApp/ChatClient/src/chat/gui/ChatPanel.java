...
public class ChatPanel extends JPanel {
    ...
    private final Color MSG_FROM_COLOR = new Color(228, 232, 235);
    private final Color MSG_ME_COLOR = new Color(190, 241, 140);
    private final Color MSG_PRIV_FROM = new Color(180, 220, 140);
    private final Color MSG_PRIV_ME = new Color(200, 247, 160);
    private final Color MSG_SERVER = new Color(150, 150, 150);
    ...
    private final Dimension INPUT_FIELD_SIZE = new Dimension(250, 530);
    private final Font DEFAULT_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, 12);
    private final Font GLOBAL_MSG_FONT = new Font(Font.MONOSPACED, Font.BOLD, 11);
    private final Font TIME_MSG_FONT = new Font(Font.MONOSPACED, Font.BOLD, 8);
    private final Insets TEXT_FIELD_INSETS = new Insets(5, 8, 5, 8);
    private final Insets ME_INSETS = new Insets(5, 20, 5, 5);
    private final Insets FROM_INSETS = new Insets(5, 5, 5, 20);
    private final Insets SERVER_MESSAGE_INSETS = new Insets(5, 40, 5, 20);
    ...
    protected void updateTextArea(List<Message> newMsgs) {
        ...
        for (int i = 0; i < newMsgs.size(); i++) {
            ...
            timeLabel.setFont(TIME_MSG_FONT);
