...
public class InputPanel extends JPanel {
    ...
    private final Color BACKGROUND_ON_FOCUS = new Color(255, 255, 255);
    ...
    private final Dimension SIZE = new Dimension(0, 50);
    private final Dimension INPUT_FIELD_SIZE = new Dimension(250, 50);
