...
public class LoginPanel extends JPanel {
    ...
    private final Color BUTTON_TEXT_COLOR = new Color(89, 92, 99);
    private final Color ERROR_TEXT_COLOR = new Color(89, 92, 99);
    private final Color BACKGROUND_COLOR = new Color(244, 245, 246);
    ...
    private final String LOGIN_ERROR_TEXT = "Username is used";
    ...
    private void init() {
        ...
        usernameLabel.setForeground(ERROR_TEXT_COLOR);
    ...
    public void attemptLogin() {
        try {
            ...
            loginErrorLabel.setVisible(true);
            loginErrorLabel.setText("Server is down!");
            loginErrorLabel.setForeground(Color.RED);
