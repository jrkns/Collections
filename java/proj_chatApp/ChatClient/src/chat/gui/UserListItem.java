...
public class UserListItem extends JPanel {
    ...
    private Color BUTTON_USER = new Color(190, 241, 140);
    private Color BUTTON_USER_PRESSED = BUTTON_USER.darker().darker();
    private Color BUTTON_USER_OVER = BUTTON_USER.darker();
    private Color USER_TEXT_COLOR = new Color(0, 0, 0);
    private Color BUTTON_TEXT_COLOR = new Color(255, 255, 255);
